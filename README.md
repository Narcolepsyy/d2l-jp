...
> <p>"AI 革命は、10年足らずのうちに研究室から幅広い産業へ、そして私たちの日常生活の隅々へと広がりました。Dive into Deep Learning はディープラーニングに関する उत्कृष्टなテキストであり、ディープラーニングがなぜ AI 革命に火をつけたのかを学びたいすべての人に注目されるべき本です。現代における最も強力な技術的原動力です。"</p>
...
[Chinese version](https://github.com/d2l-ai/d2l-zh) | [Code of conduct](CODE_OF_CONDUCT.md)
