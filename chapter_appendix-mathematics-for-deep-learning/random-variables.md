...
前節では p.d.f. の概念を見た。実際には、連続確率変数を扱う際によく使われる方法であるが、1つ大きな落とし穴がある。p.d.f. の値そのものは確率ではなく、確率を得るために積分しなければならない関数だということである。密度が $10$ より大きくても、それが長さ $1/10$ を超える区間にわたって大きくなければ問題ない。直感に反することがあるため、人々はしばしば *累積分布関数*、すなわち c.d.f. でも考える。こちらは *確率* である。
