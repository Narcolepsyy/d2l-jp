...
次に、2階導関数が負の定数である場合、1階導関数が減少していることを意味する。、1階導関数が最初は正で、ある点で0になり、その後負になることを示す。したがって、関数 $f$ 自体は増加し、平らになり、その後減少する。言い換えれば、関数 $f$ は下に曲がっており、 :numref:`fig_negative-second` に示すように1つの最大値を持つ。
