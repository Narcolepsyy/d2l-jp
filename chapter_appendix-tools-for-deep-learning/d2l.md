...
この節では、`d2l` パッケージに含まれるクラスと関数をアルファベット順に示し、それらが本書のどこで定義されているかを示します。これにより、より詳細な実装や説明を見つけることができます。  
[GitHub リポジトリ](https://github.com/d2l-ai/d2l-en/tree/master/d2l) のソースコードも参照してください。
