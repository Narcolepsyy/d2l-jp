...
ノートブックをダウンロードします。
[D2L.ai の Web サイト](https://d2l.ai/) の任意の HTML ページ上部にある
...
（すでに自動的に開いている場合もあります）にアクセスできるようになります。
そこから、本書の各節のコードを実行できます。
