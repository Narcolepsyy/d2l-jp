...
いよいよ深層ニューラルネットワークの探究を始めることができる。
...
以下に tanh 関数をプロットする。入力が 0 に近づくと、tanh 関数は線形変換に近づくことに注意されたい。関数の形はシグモイド関数に似ているが、tanh 関数は座標系の原点に関して点対称です :cite:`Kalman.Kwasny.1992`。
