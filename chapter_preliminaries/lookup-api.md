...
[API ドキュメント](https://mxnet.apache.org/versions/1.8.0/api)
や追加の [チュートリアル](https://mxnet.apache.org/versions/1.8.0/api/python/docs/tutorials/) と例が
そのような文書を提供しています。
この節では、MXNet の API を調べるための指針を示します。
:end_tab:
...
公式ドキュメントには、この本の範囲を超える豊富な説明と例があります。
私たちは、網羅性よりも、
実際の問題にすばやく取り組み始められるようにするための重要な使用例を重視します。
また、ライブラリのソースコードを調べて、
...
:begin_tab:`mxnet`
[議論](https://discuss.d2l.ai/t/38)
:end_tab:

:begin_tab:`pytorch`
[議論](https://discuss.d2l.ai/t/39)
:end_tab:

:begin_tab:`tensorflow`
[議論](https://discuss.d2l.ai/t/199)
:end_tab:

:begin_tab:`jax`
[議論](https://discuss.d2l.ai/t/17972)
:end_tab:\n