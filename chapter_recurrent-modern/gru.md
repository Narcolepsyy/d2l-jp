...
**ゲート付き再帰ユニット（GRU: Gated Recurrent Unit）とは**、再帰型ニューラルネットワーク（RNN）の一種であり、LSTMよりも簡潔な構造を持ちながら、長期の依存関係を効果的に学習できるよう設計された、高速で効率的なモデルである。
...
まだ*候補*である。なぜなら、更新ゲートの働きをまだ組み込む必要があるからである。
